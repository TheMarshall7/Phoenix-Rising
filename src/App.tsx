...
const Button = ({ children, className = "", variant = "primary" }: { children: ReactNode, className?: string, variant?: "primary" | "secondary" | "outline" }) => {
...
export default function App() {
  return (
    <div className="min-h-screen selection:bg-sage/30 bg-cream">
      ...
      <section className="relative min-h-screen flex items-center bg-burgundy overflow-hidden">
        <div className="absolute inset-0 z-0 flex flex-col md:flex-row">
          <div className="w-full md:w-1/2 relative h-full">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-cream/20 to-cream hidden md:block"></div>
            <div className="absolute inset-0 bg-gradient-to-t from-cream via-cream/40 to-transparent md:hidden"></div>
          </div>
          <div className="w-full md:w-1/2 bg-cream h-full hidden md:block relative z-0"></div>
        </div>
        ...
        <div className="relative z-10 container mx-auto px-8 w-full grid md:grid-cols-2 items-center min-h-screen">
          <div className="hidden md:flex items-center justify-center">
             <motion.div 
               ...
               className="vertical-text text-[15vh] font-serif italic text-ink pointer-events-none"
             >
               Embodiment
             </motion.div>
          </div>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              <Button variant="primary">Join the Journey</Button>
              <div className="flex items-center gap-4 text-[10px] tracking-widest uppercase font-bold text-ink/40">
        ...
        <div className="container-narrow relative z-10">
          <div className="grid md:grid-cols-12 gap-16 items-start">
            <div className="md:col-span-5 md:sticky md:top-32">
              ...
              <h2 className="text-6xl md:text-8xl font-light leading-tight mb-12 text-burgundy">THE CORE <br /><span className="font-serif italic">shift</span></h2>
      ...
      <Section className="relative bg-burgundy text-cream py-48 text-center overflow-hidden">
        ...
        <div className="container-narrow relative z-10">
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl mb-12 font-light leading-tight">
        ...
        <div className="container-narrow">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-4xl md:text-6xl mb-8 font-light text-burgundy">
                MIDDLE EASTERN <span className="font-serif italic">grounding</span>
              </h2>
      ...
      <Section id="roadmap" className="bg-paper text-ink py-48 border-y border-ink/5">
        <div className="container-narrow">
            ...
            <div className="md:col-span-2 grid sm:grid-cols-2 gap-x-12 gap-y-20">
              {[
                ...
                >
                  ...
                  <h3 className="text-2xl font-serif italic text-burgundy mb-6 group-hover:translate-x-2 transition-transform duration-700">{phase.title}</h3>
                  <p className="text-ink/60 font-light text-sm leading-relaxed">{phase.desc}</p>
                </motion.div>
              ))}
            </div>
          </div>
      ...
      <Section id="workshops" className="bg-cream text-ink py-48 relative overflow-hidden">
        ...
        <div className="container-narrow">
          <div className="text-center mb-32">
            ...
            <h2 className="text-7xl md:text-9xl mb-10 font-light text-burgundy">THE <span className="font-serif italic">workshops</span></h2>
      ...
      {/* THE FACULTY SECTION */}
      <Section id="faculty" className="bg-burgundy text-cream py-48">
        <div className="container-narrow">
          <div className="text-center mb-32">
            <p className="text-sage text-[10px] tracking-[0.5em] uppercase mb-6 font-bold">The Faculty</p>
            <h2 className="text-7xl md:text-9xl mb-10 font-light">OUR <span className="font-serif italic">practitioners</span></h2>
            ...
            {[
              ...
              >
                <div className="relative mb-8">
                  <div className="w-32 h-32 md:w-40 md:h-40 mx-auto oval-mask bg-cream/5 flex items-center justify-center border border-cream/10 group-hover:border-sage/50 transition-colors duration-700">
                     <span className="text-sage font-serif italic text-3xl opacity-40 group-hover:opacity-100 transition-opacity duration-700">{practitioner.name.charAt(0)}</span>
                  </div>
                  <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 w-px h-8 bg-sage/30 group-hover:h-12 transition-all duration-700"></div>
                </div>
                <p className="text-[11px] tracking-[0.3em] uppercase font-bold text-cream mb-2">{practitioner.name}</p>
                <p className="text-[9px] tracking-[0.2em] uppercase text-sage italic font-medium">{practitioner.title}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <Section className="bg-burgundy text-cream py-48 relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full opacity-5 pointer-events-none">
          <div className="absolute top-1/4 -left-20 text-[20vw] font-serif italic vertical-text">Practice</div>
          <div className="absolute bottom-1/4 -right-20 text-[20vw] font-serif italic vertical-text">Integration</div>
        </div>

        <div className="container-narrow relative z-10">
          <div className="text-center mb-32">
            <p className="text-sage text-[10px] tracking-[0.5em] uppercase mb-6 font-bold">The Distinction</p>
            <h2 className="text-7xl md:text-9xl mb-10 font-light">WHAT MAKES THIS <br /><span className="font-serif italic">different</span></h2>
            ...
            >
              ...
              <ul className="space-y-6">
                {[
                  ...
                  <li key={i} className="flex items-center gap-6 text-cream/50 font-light group">
                    <div className="w-1 h-1 bg-cream/20 group-hover:bg-sage transition-colors"></div>
                    <span className="text-lg font-serif italic group-hover:text-cream transition-colors">{item}</span>
                  </li>
                ))}
              </ul>
            </motion.div>
            ...
            >
              ...
              <ul className="space-y-6">
                {[
                  ...
                  <li key={i} className="flex items-center gap-6 text-cream font-light group">
                    <Check className="w-4 h-4 text-sage opacity-40 group-hover:opacity-100 transition-opacity" />
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-x-16 gap-y-8 max-w-4xl mx-auto text-left">
              {[
                ...
                <li key={i} className="flex items-start gap-4 text-ink/80 font-light text-lg list-none">
                  <span className="text-sage font-serif italic text-xl leading-none">0{i+1}</span>
                  <span>{item}</span>
                </li>
              ))}
            </div>
      ...
      <Section className="bg-paper text-ink py-48 overflow-hidden">
        <div className="container-narrow text-center mb-32">
          ...
          <h2 className="text-6xl md:text-8xl mb-10 font-light text-burgundy">GLIMPSES OF <br /><span className="font-serif italic">the journey</span></h2>
        </div>
      ...
      <Section className="bg-cream text-ink py-48 border-b border-ink/5">
        <div className="container-narrow">
          <div className="text-center mb-32">
            ...
            <h2 className="text-7xl md:text-9xl mb-10 font-light text-burgundy">PRACTICAL <span className="font-serif italic">details</span></h2>
          </div>
        ...
        <div className="container-narrow relative z-10">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="pl-4 md:pl-12">
              ...
              <h2 className="text-5xl md:text-6xl font-light text-cream leading-tight mb-16">THE ORIGIN <br /><span className="font-serif italic text-sage">of Phoenix</span></h2>
          ...
          <div className="grid md:grid-cols-2 gap-24 items-end mb-32">
            <div>
              <div className="mb-12">
                ...
                <h2 className="text-6xl md:text-8xl font-light leading-[0.85]">21 DAYS <br /><span className="font-serif italic">of living.</span></h2>
              </div>
